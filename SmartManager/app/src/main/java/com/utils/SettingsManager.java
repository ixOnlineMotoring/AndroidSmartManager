...
public class SettingsManager {
    ...
    private float swipeOffsetLeft = 100;
    private float swipeOffsetRight = 100;
    private int swipeActionLeft = SwipeListView.SWIPE_ACTION_NONE;
    private int swipeActionRight = SwipeListView.SWIPE_MODE_NONE;
