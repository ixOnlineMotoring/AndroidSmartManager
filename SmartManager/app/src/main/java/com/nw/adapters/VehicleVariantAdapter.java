...
public class VehicleVariantAdapter extends ArrayAdapter<SpecialVehicle> {

	public VehicleVariantAdapter(Context context, int resource, List<SpecialVehicle> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		/*if(!getItem(position).getFriendlyName().equals("No Vehicle Name Loaded"))
		...
		holder.tvStock.setText(Html.fromHtml("<font color=\"#FF0707\">"+getItem(position).getUsedYear()+" | "+getItem(position).getStockCode()+" | "+getItem(position).getColour()+"</font>"));
